...
export default function Hero() {
    ...
    return (
        <section
            ...
            className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#050505] text-white py-20 lg:py-0"
        >
            ...
            <div className="max-w-7xl w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                <div className="col-span-1 lg:col-span-7 flex flex-col items-start gap-8">
                    ...
                    <div className="relative">
                        ...
                        >
                            {["I", "AM", "FILIPPOS", "ZYGOURIS."].map((word, i) => (
                    ...
                    >
                        <h2 className="text-2xl md:text-3xl font-light text-gray-300">
                            Computer Engineer <span className="text-blue-500 font-mono">(M.Eng.)</span>
                        </h2>
                        <p className="text-lg text-gray-400 leading-relaxed font-light">
                            Specializing in <span className="text-white font-medium">SaMD Quality Assurance</span> & <span className="text-white font-medium">AI Regulations</span>.
                            Architecting sovereign, compliant infrastructure for the next generation of digital medicine.
                        </p>
                    </motion.div>

                    {/* CTAs (Magnetic Effect simulation with Framer) */}
                    <motion.div
                    ...
                    >
                        <button className="group relative px-8 py-4 bg-white text-black font-bold text-sm tracking-widest uppercase rounded hover:scale-105 transition-transform">
                        ...
                        >
                            Recent Work <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                        </Link>
                    </motion.div>
