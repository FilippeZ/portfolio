...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-start justify-center md:justify-start pt-24 md:pt-32 relative overflow-hidden font-display selection:bg-primary selection:text-white">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-500/10 rounded-full blur-[120px] z-[1]" />
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-500/10 rounded-full blur-[120px] z-[1]" />

            <motion.div
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="w-full max-w-lg p-8 md:pl-24 lg:pl-32 z-10"
            >
                <div className="text-left mb-10">
                    <h1 className="text-4xl font-extrabold text-white tracking-tighter mb-3 leading-tight uppercase bg-clip-text text-transparent bg-gradient-to-tr from-white to-white/60">
                        Welcome to my Portfolio Access Portal
                    </h1>
                    <p className="text-blue-400/80 text-xs font-mono tracking-[0.4em] uppercase font-bold">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 text-white rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 outline-none transition-all placeholder:text-gray-600"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full bg-white/5 border border-white/10 text-white rounded-2xl py-4 pl-12 pr-4 focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500 outline-none transition-all placeholder:text-gray-600"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-4 rounded-2xl shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden relative"
                        >
                            <AnimatePresence mode="wait">
                                {isLoading ? (
                                    <motion.div
